...
goal = (199,199) # Bottom-right corner
...
# mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_length)
# functions_v2.plot_histogram(count)
...
# shortest_path, shortest_path_length, runtime, count= dijkstra_v4.dijkstra_path_8(matrix,limit=5)
# ship_path = shortest_path
# mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_length)
# functions_v2.plot_histogram(count)
# print("runtime is: ", runtime)
...
# shortest_path, shortest_path_length, runtime, count = dijkstra_v4.dijkstra_path_8fixed(matrix, threshold=2, penalty=2)
# ship_path = shortest_path
# mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_lengt)
# print("runtime is: ", runtime)
# print("occurrences of each value from 1 to 7 in the matrix : ", count)
...
# shortest_path, shortest_path_length,runtime, count = dijkstra_v4.dijkstra_path_8vary(matrix, threshold=2, penalty_rate=1)
# ship_path = shortest_path
# mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_length)
# functions_v2.plot_histogram(count)
# print("runtime is: ", runtime)
...
shortest_path, shortest_path_length,runtime, count  = dijkstra_v4.dijkstra_path_8final(matrix, limit=5, threshold=2, penalty_rate=1)
ship_path = shortest_path
mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_length)
functions_v2.plot_histogram(count)
print(shortest_path)
...
# # extra: when able to move diagonal and add various penalty and a fixed limit
# shortest_path, shortest_path_length,runtime, count  = dijkstra_v4.dijkstra_path_8extra(matrix, ship_speed, limit=5, threshold=2, penalty_rate=1)
# ship_path = shortest_path
# mean_risk_value,ship_time = functions_v2.averagingandspeed(matrix, ship_path,shortest_path_lengt)
# print("runtime is: ", runtime)
# print("occurrences of each value from 1 to 7 in the matrix: ", count)
...
# functions_v2.plot_histogram(count)
# mean_risk_value , ship_time = functions_v2.averagingandspeed(matrix, ship_path,ship_path_length)
# print("runtime is: ", runtime)
# print("occurrences of each value from 1 to 7 in the matrix: ", count)
...
# simple_matrix = np.array(simple_matrix)
# ship_path, ship_path_length, runtime, count= a_star_v1.a_star_search_8(simple_matrix, start, goal,limit=5)
# ship_path = ship_path[::-1]  # Reverse path to start from the beginning
# mean_risk_value, ship_time = functions_v2.averagingandspeed(matrix, ship_path,ship_path_length)
# functions_v2.plot_histogram(count)
# print("runtime is: ", runtime)
...
# ship_path = ship_path[::-1]  # Reverse path to start from the beginning
# mean_risk_value, ship_time = functions_v2.averagingandspeed(matrix, ship_path,ship_path_legnth)
# print("runtime is: ", runtime)
# print("occurrences of each value from 1 to 7 in the matrix: ", count)
...
# simple_matrix = np.array(simple_matrix)
# ship_path, ship_path_length, runtime, count= a_star_v1.a_star_search_8final(simple_matrix, start, goal,threshold=2, penalty_rate=1, limit =5)
# ship_path = ship_path[::-1]  # Reverse path to start from the beginning
# mean_risk_value, ship_time = functions_v2.averagingandspeed(matrix, ship_path,ship_path_length)
# functions_v2.plot_histogram(count)
# print("runtime is: ", runtime)
